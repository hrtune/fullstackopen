...
describe('most blogs', () => {
  ...
  test('of one blog is the author with one blog', () => {
    const result = mostBlogs(Array(blogs[0]))
  ...
  test('of three blogs is the one who has two blogs', () => {
  ...
  test('of many blogs is the one who has the most blogs', () => {
